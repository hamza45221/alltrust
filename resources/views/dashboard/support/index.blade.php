                    ...
                    @foreach($supports as $index => $support)
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="fw-medium">{{$support->title}}</span>
                            </td>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item waves-effect" data-bs-toggle="modal"
                                           data-bs-target="#useredit{{$support->id}}"><i class="ti ti-pencil me-1"></i> Edit</a>
                                        <a class="dropdown-item waves-effect" href="{{ route('faq-delete', ['id' => $support->id]) }}"><i class="ti ti-trash me-1"></i> Delete</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
                        ...
                        <div class="modal fade" id="useredit{{$support->id}}" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('faq-update', ['id' => $support->id]) }}" method="post">
                                        @csrf
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col mb-4">
                                                    <label for="question" class="form-label">Question</label>
                                                    <input type="text" name="question" value="{{ $support->question }}" id="question" class="form-control" placeholder="Enter Question" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col mb-4">
                                                    ...
                                                    <textarea  name="answer" id="answer" class="form-control" placeholder="Enter Answer" >{{ $support->answer}}</textarea>
                                                </div>
                                            </div>
